        ...
        protected void GetInventoryData()
        {
            ...
            using (Entities _context = new Entities())
            {
                var data = (from d in _context.DAILY_ACTIVITY_INVENTORY
                            ...
                            select new { j.ENABLED_FLAG, j.ITEM_ID, j.ACTIVE, j.SEGMENT1, j.LE, j.LAST_UPDATE_DATE, j.ATTRIBUTE2, j.INV_LOCATION, j.INV_NAME, d.INVENTORY_ID, d.SUB_INVENTORY_SECONDARY_NAME,j.UOM_CODE, d.UNIT_OF_MEASURE, d.SUB_INVENTORY_ORG_ID, j.DESCRIPTION, d.RATE}).ToList();
