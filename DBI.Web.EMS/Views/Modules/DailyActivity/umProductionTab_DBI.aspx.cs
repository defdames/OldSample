        ...
        protected void GetCurrentProduction()
        {
            ...
            using (Entities _context = new Entities())
            {
                var data = (from d in _context.DAILY_ACTIVITY_PRODUCTION
                            ...
                            select new { d.PRODUCTION_ID, h.PROJECT_ID, p.LONG_NAME, t.TASK_ID, t.TASK_NUMBER, t.DESCRIPTION, d.TIME_IN, d.TIME_OUT, d.WORK_AREA, d.POLE_FROM, d.POLE_TO, d.ACRES_MILE, d.QUANTITY }).ToList();
