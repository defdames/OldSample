...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport runat="server" ID="uxViewPort" Layout="BorderLayout" IDMode="Explicit" Namespace="App" RenderXType="True">
            <Items>
                <ext:GridPanel ID="uxOrganizationsGrid" runat="server" Flex="1" SimpleSelect="true" Title="Organization Security By Hierarchy" Padding="5" Region="North">
                    <Store>
                ...
                <ext:GridPanel ID="GridPanel1" runat="server" Flex="1"  Title="General Ledger Accounts" Padding="5" Region="Center">
                     <TopBar>
