    ...
    public partial class umAddGLAccountRange : DBI.Core.Web.BasePage
    {
        ...
        protected void deLoadSegment(object sender, StoreReadDataEventArgs e)
        {
           ...
           Entities _context = new Entities();          
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT1, ID_NAME = x.SEGMENT1 + " (" + x.SEGMENT1_DESC + ")" }).Distinct().OrderBy(x => x.ID);
                   uxSRSegment1Store.DataSource = _data.ToList();
               }

               if (_storeDetails.ID == "uxSRSegment2Store")
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT2, ID_NAME = x.SEGMENT2 + " (" + x.SEGMENT2_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value && x.SEGMENT2 == uxSRSegment2.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT3, ID_NAME = x.SEGMENT3 + " (" + x.SEGMENT3_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value && x.SEGMENT2 == uxSRSegment2.SelectedItem.Value && x.SEGMENT3 == uxSRSegment3.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT4, ID_NAME = x.SEGMENT4 + " (" + x.SEGMENT4_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value && x.SEGMENT2 == uxSRSegment2.SelectedItem.Value && x.SEGMENT3 == uxSRSegment3.SelectedItem.Value && x.SEGMENT4 == uxSRSegment4.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT5, ID_NAME = x.SEGMENT5 + " (" + x.SEGMENT5_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value && x.SEGMENT2 == uxSRSegment2.SelectedItem.Value && x.SEGMENT3 == uxSRSegment3.SelectedItem.Value && x.SEGMENT4 == uxSRSegment4.SelectedItem.Value && x.SEGMENT5 == uxSRSegment5.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT6, ID_NAME = x.SEGMENT6 + " (" + x.SEGMENT6_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value && x.SEGMENT2 == uxSRSegment2.SelectedItem.Value && x.SEGMENT3 == uxSRSegment3.SelectedItem.Value && x.SEGMENT4 == uxSRSegment4.SelectedItem.Value && x.SEGMENT5 == uxSRSegment5.SelectedItem.Value && x.SEGMENT6 == uxSRSegment6.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT7, ID_NAME = x.SEGMENT7 + " (" + x.SEGMENT7_DESC + ")" }).Distinct().OrderBy(x => x.ID);
               ...
               if (_storeDetails.ID == "uxERSegment1Store")
               {
                   ...
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxSRSegment1.SelectedItem.Value).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT1, ID_NAME = x.SEGMENT1 + " (" + x.SEGMENT1_DESC + ")" }).Distinct().OrderBy(x => x.ID);
                   uxERSegment1Store.DataSource = _data.ToList();
               }

               if (_storeDetails.ID == "uxERSegment2Store")
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxERSegment1.SelectedItem.Value && String.Compare(x.SEGMENT2, uxSRSegment2.SelectedItem.Value) >= 0).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT2, ID_NAME = x.SEGMENT2 + " (" + x.SEGMENT2_DESC + ")" }).Distinct().OrderBy(x => x.ID);
                   uxERSegment2Store.DataSource = _data.ToList();
               }

               if (_storeDetails.ID == "uxERSegment3Store")
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxERSegment1.SelectedItem.Value && x.SEGMENT2 == uxERSegment2.SelectedItem.Value && String.Compare(x.SEGMENT3, uxSRSegment3.SelectedItem.Value) >= 0).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT3, ID_NAME = x.SEGMENT3 + " (" + x.SEGMENT3_DESC + ")" }).Distinct().OrderBy(x => x.ID);
                   uxERSegment3Store.DataSource = _data.ToList();
               }

               if (_storeDetails.ID == "uxERSegment4Store")
               {
                   IQueryable<DBI.Data.Generic.DoubleComboStringID> _data = _context.GL_ACCOUNTS_V.Where(x => x.SEGMENT1 == uxERSegment1.SelectedItem.Value && x.SEGMENT2 == uxERSegment2.SelectedItem.Value && x.SEGMENT3 == uxERSegment3.SelectedItem.Value && String.Compare(x.SEGMENT4, uxSRSegment4.SelectedItem.Value) >= 0).Select(x => new DBI.Data.Generic.DoubleComboStringID { ID = x.SEGMENT4, ID_NAME = x.SEGMENT4 + " (" + x.SEGMENT4_DESC + ")" }).Distinct().OrderBy(x => x.ID);
