                    ...
                    <TopBar>
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:Button ID="Button1" runat="server" Text="Account Details" Icon="DatabaseGear">
            ...
            <Items>
                 <ext:GridPanel ID="GridPanel2" runat="server" Flex="1" Title="Account Detail Lines" Padding="5" Region="North" >
                     <TopBar>
                         <ext:Toolbar runat="server">
                             <Items>
                                 <ext:Button runat="server" Text="Add" icon="ApplicationAdd"></ext:Button>
                                   <ext:Button ID="Button2" runat="server" Text="Delete" icon="ApplicationDelete"></ext:Button>
                                   <ext:Button ID="Button3" runat="server" Text="Edit" Icon="ApplicationEdit"></ext:Button>
                             </Items>
                         </ext:Toolbar>
                     </TopBar>
                    <Store>
                    ...
                    <ColumnModel>
                       <Columns>
                            ...
                            <ext:ComponentColumn runat="server" DataIndex="SEGMENT2" Text="Comments" Flex="2">
                                <Component>
                                    <ext:TextArea runat="server"></ext:TextArea>
                                </Component>
                            </ext:ComponentColumn>
                        </Columns>
                    </ColumnModel>
