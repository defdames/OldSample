...
<body>
    <form id="form1" runat="server">
                        ...
                        <ext:Panel runat="server" Title="Survey List" Layout="BorderLayout">
                            <Items>
                                <ext:TreePanel
                                    ...
                                    <Listeners>
                                        <ItemClick Handler="#{uxProjectStore}.reload(); #{uxExportButton}.enable()" />
                                    </Listeners>
                                </ext:TreePanel>
                            ...
                            <TopBar>
                                <ext:Toolbar runat="server">
                                    <Items>
                                        <ext:Button runat="server" ID="uxExportButton" Text="Export to Excel" Icon="PageWhiteExcel" Disabled="true">
                                            <Listeners>
                                                <Click Handler="#{uxExportWindow}.show()" />
                                            </Listeners>
                                        </ext:Button>
                                    </Items>
                                </ext:Toolbar>
        ...
        <ext:Window runat="server" ID="uxExportWindow" Title="Choose Date Range" Hidden="true" Width="650" Resizable="false" Closable="false">
            <Items>
                <ext:FormPanel runat="server" ID="uxDatesForm" Layout="FormLayout">
                    <Items>
                        <ext:DateField runat="server" ID="uxStartDate" IsRemoteValidation="true" FieldLabel="Start Date" AllowBlank="false">
                            <RemoteValidation OnValidation="ValidateDate" />
                        </ext:DateField>
                        <ext:DateField runat="server" ID="uxEndDate" IsRemoteValidation="true" FieldLabel="End Date" AllowBlank="false">
                            <RemoteValidation OnValidation="ValidateDate" />
                        </ext:DateField>
                    </Items>
                    <Buttons>
                    ...
                    <Listeners>
                        <ValidityChange Handler="#{uxSubmitDates}.setDisabled(!valid)" />
                    </Listeners>
                </ext:FormPanel>
            </Items>
        </ext:Window>
