                    ...
                    <Items>
                        ...
                        <ext:FieldContainer ID="FieldContainer1"
                            ...
                            <Items>
                                ...
                                <ext:Label ID="Label5" runat="server" Width="315" />
                            </Items>
                        </ext:FieldContainer>
                        ...
                        <ext:FieldContainer ID="FieldContainer4"
                            ...
                            <Items>
                                ...
                                <ext:Label ID="Label2" runat="server" Width="45" />
                            </Items>
                        </ext:FieldContainer>
                        ...
                        <ext:FieldContainer ID="FieldContainer2"
                            ...
                            Layout="HBoxLayout">
                            <Items>
                                <ext:Label ID="Label4" runat="server" Width="545" Height="60" />
                            </Items>
                        </ext:FieldContainer>
                        ...
                        <ext:FieldContainer ID="FieldContainer17"
                            ...
                            Layout="HBoxLayout">
                            <Items>
                                <ext:Label ID="Label3" runat="server" Width="390" />
