        ...
        <ext:GridPanel
            ...
            <ColumnModel ID="ColumnModel1" runat="server">
                <Columns>
                    ...
                    <ext:DateColumn ID="DateColumn4" runat="server" DataIndex="APPROVED_DATE" Text="Approved Date" Flex="1" Format="MM/dd/yyyy" />                
                    <ext:Column ID="Column11" runat="server" Text="Service Type" DataIndex="SERVICE_TYPE" Flex="1"  />
                    <ext:Column ID="Column3" runat="server" Text="Square Feet" DataIndex="SQUARE_FEET" Flex="1"  />
                    <ext:Column ID="Column4" runat="server" Text="Project #" DataIndex="SEGMENT1" Flex="1"  />                    
