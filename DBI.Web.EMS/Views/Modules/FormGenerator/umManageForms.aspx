                    ...
                    <Items>
                        <ext:FormPanel runat="server" ID="uxCopyForm" Layout="FormLayout">
                            <Items>
                                ...
                                <ext:ComboBox ID="uxCopyFormOrg" runat="server" ForceSelection="true" TypeAhead="true" QueryMode="Local" ValueField="ORG_ID" DisplayField="ORG_HIER" AllowBlank="false" EmptyText="Choose Organization" FieldLabel="Organization" InvalidCls="allowBlank">
                                    <Store>
                                ...
                                <ext:ComboBox ID="uxCopyFormCategory" runat="server" ForceSelection="true" TypeAhead="true" QueryMode="Local" ValueField="CATEGORY_ID" DisplayField="NAME" AllowBlank="false" EmptyText="Choose Category" FieldLabel="Category" InvalidCls="allowBlank">
                                    <Store>
